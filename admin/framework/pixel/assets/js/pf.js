...
;(function( $, window, document, undefined ) {
  ...
  $.fn.pf_field_repeater = function() {
    return this.each( function() {
      ...
      var $this     = $(this),
          ...
          $wrapper  = $fieldset.children('.pf-repeater-wrapper'),
          $hidden   = $fieldset.children('.pf-repeater-hidden'),
          $max      = $fieldset.children('.pf-repeater-max'),
          $min      = $fieldset.children('.pf-repeater-min'),
      ...
      $fieldset.children('.pf-repeater-hidden').children('.pf-repeater-helper').on('click', '.pf-repeater-clone', event_clone);
  ...
  $.fn.pf_field_group = function() {
    return this.each( function() {
      ...
      var $this     = $(this),
          ...
          $wrapper  = $fieldset.children('.pf-cloneable-wrapper'),
          $hidden   = $fieldset.children('.pf-cloneable-hidden'),
          $max      = $fieldset.children('.pf-cloneable-max'),
          $min      = $fieldset.children('.pf-cloneable-min'),
          field_id  = $wrapper.data('field-id'),
          unique_id = $wrapper.data('unique-id'),
    ...
    return this.each( function() {
      ...
      $upload_button.on('click', function( e ) {
        ...
        wp_media_frame.on( 'select', function() {
          ...
          $this.find('.pf--url').val( attributes.url );
          ...
          $this.find('.pf--thumbnail').val( thumbnail ).trigger('change');
      ...
      $remove_button.on('click', function( e ) {
        ...
        $this.find('input').val('');
        $this.find('.pf--thumbnail').trigger('change');
      });
        ...
        create: function() {
          ...
          var a8cIris = $input.data('a8cIris'),
              $transparent_wrap = $('<div class="pf--transparent-wrap">' +
                                ...
                                '<div class="pf--transparent-button button button-small">transparent</div>' +
    ...
    return this.each( function() {
      ...
      $(this).find('.pf-taxonomy-content-tab .pf-taxonomy-selected-all .pf--button').on("click", function(e){
        if( $(this).find("input[type='radio']").val() ){
          ...
          $(this).parent().parent().next('.pf-taxonomy-collapse').css("display","block");
        }
      });
  ...
  $.fn.pf_customizer_listen = function( options ) {
    ...
    return this.each( function() {
      ...
      $input.on('change keyup', PF.helper.debounce( function() {
        ...
        var obj = $this.find(':input').serializeObject();
  ...
  $(document).on('expanded', '.control-section-pf', function() {
    ...
    if( $this.hasClass('open') && !$this.data('inited') ) {
      $this.pf_dependency();
      $this.find('.pf-customize-field').pf_reload_script({dependency: false});
      $this.find('.pf-customize-complex').pf_customizer_listen();
      ...
      $input.autocomplete({
        source: function(req, response){
          ...
          jQuery.ajax({
            ...
            dataType: 'json',
            url     : ajaxurl,
            data    : 'action=pf-search-post-ajax&nonce=' + nonce +'&q='+ req.term + '&cpt='+ cpt + '&exclude='+ $input_values.val() + '&filter=' + is_filter,
  ...
  $.fn.pf_reload_script = function( options ) {
    ...
    return this.each( function() {
      ...
      if( !$this.data('inited') ) {
        ...
        $this.children('.pf-field-dimensions').find('.pf-number').pf_number();
        $this.children('.pf-field-slider').find('.pf-number').pf_number();
        $this.children('.pf-field-spacing').find('.pf-number').pf_number();
        $this.children('.pf-field-spinner').find('.pf-number').pf_number();
        $this.children('.pf-field-typography').find('.pf-number').pf_number();
        $this.children('.pf-field-styling').find('.pf-number').pf_number();
