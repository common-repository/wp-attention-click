 ...
 * @since 1.2.2 2019-03-20 14:11:52 - Removed spaces in the file header.
...
     * You can create multiple instances with different $keys.
     ...
     *
     * @since 1.0 2019-02-22 00:32:53 Release
     *
     * @param array $sections
     * @return void
     */
     ...
     *
     * @since	1.2.3 2019-03-21 06:23:08 Release
     *
    ...
    public function add_button_setting( $ajax_class, $name_options = '' ){
        echo '<div class="pf-buttons">';
        do_action("pixel_options_{$this->unique}_buttons_before");
        echo '<input type="submit" name="'. $this->unique .'[_nonce][save]" class="button button-primary pf-save'. $ajax_class .'" value="'. esc_html__( 'Save', 'pf' ) .'" data-save="'. esc_html__( 'Saving...', 'pf' ) .'">';
        ...
        echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="pf_transient[reset]" class="button button-secondary pf-warning-primary pf-reset-all pf-confirm" value="'. esc_html__( 'Reset All', 'pf' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset all options?', 'pf' ) .'">' : '';
     ...
     * @since   1.2.7   2019-03-27      Added core variable 'PF::$errors_fields
     *                                      to be able to save individual error.
    ...
    public function add_options_html(){
        ...
        echo '<div class="pf pf-options pf-' . $this->unique . $theme . $class .' '. $vertical_mode . '"
                        ...
                        echo '<div class="pf-nav pf-nav-options">';
                            ...
                            foreach( $this->pre_tabs as $tab ) {
                                ...
                                if( ! empty( $tab['sub'] ) ) {
                                    ...
                                    echo '<li class="pf-tab-depth-0 pf-tab-with-subtabs">';
