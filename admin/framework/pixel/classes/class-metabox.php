...
if( ! class_exists( 'PF_classMetabox' ) ) {
	class PF_classMetabox{
		...
		public function __construct( $key, $params = array() ) {
			...
			//echo json_encode( $this->pre_fields );
	...
	     * You can create multiple instances with different $keys.
		...
		*/
		 ...
		 *
		 * @since   1.4     2019-04-20 15:35:21   Release
		 *
			...
			echo '<div class="pf pf-metabox pf-metabox-'. $this->unique . $theme . $class.'">';
				...
				echo '<div class="pf-content">';
					...
					if( ! empty( $this->args['show_restore'] ) ) {
						...
						echo '<div class=" pf-metabox-restore">';
						echo '<label>';
		 ...
		 * Save metabox
		 *
		 * @since	1.4.6	2019-06-12 18:51:19		Security improvements in metabox saving
		 * @since	1.4.7	2019-07-11 01:14:21		Added improvements for default data
		 * @since	1.4.9	2019-07-12 07:42:26		Now also save the post_id of the current post
		 *
		 ...
		 *
		 * @since 	1.4.2 	2019-03-07 06:29:32 	Release
		 * @return void
		 */
		public function add_page_on_load(){
			...
			}elseif(  $post->post_type == $this->args['post_type'] ){
				add_filter( 'admin_footer_text', array( &$this, 'add_admin_footer_text' ) );
			}
